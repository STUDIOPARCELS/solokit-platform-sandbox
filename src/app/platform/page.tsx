...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'QR code personal site',
    'NFC business card',
    'event page platform',
    'AI-optimized personal website',
    'personal site subdomain',
  ...
  twitter: {
    ...
    title: 'solokit | AI-readable personal sites, portfolios, event pages, and digital cards',
    description: 'Build an AI-readable personal site on your own solokit subdomain. Book, buy, view, and RSVP from one scan.',
